...
def run(headers, user_input):
    """Get employee time/labor report from SpotOn Restaurant Reporting. Auto-detects location and defaults to today."""
    base_url = BASE_URL
  ...
  reports: getReportsData(queryFilter: $queryFilter, params: $params) {
    ...
    variables = {
        "queryFilter": {"templateName": "employeetime"},
        "params": params
    }
    ...
    return {'status_code': 200, 'body': {'time_entries': results, 'count': len(results)}}
